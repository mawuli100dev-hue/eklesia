    ...
    lectureManager.prototype.createReading = function (jour) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        texte = typeof jour.text === 'string' ? [jour.text] : jour.text;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
...
var fileName = './lectio/decembre.json';
fs.readFile(fileName, 'utf8', function (err, data) {
    //console.log(data);
    var jsonData = JSON.parse(data); // Convertir en objet JavaScript
    var read = jsonData.days;
    var title = jsonData.title;
    for (var i = 0; i < read.length; i++) {
        var manager = new lectureManager(read[i], title);
